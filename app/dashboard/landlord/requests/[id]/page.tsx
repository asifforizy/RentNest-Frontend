...
import type { RentalRequest } from "@/types/landlord";

import RequestStatusManager from "@/app/dashboard/_components/RentalStatusManager";
import { getRentalRequestById } from "@/app/dashboard/_actions/landlord";
...
export default async function RentalRequestDetailsPage({
  ...
  return (
    <div className="mx-auto mt-10 max-w-6xl space-y-6 px-5 pb-10">
      {/* Back */}
      <Link
      ...
      <div className="overflow-hidden rounded-2xl border bg-card shadow-sm">
        ...
        <div className="grid gap-8 p-6 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {request.property?.city || "Unknown city"}
      ...
      {/* Request Information + Status Manager */}
